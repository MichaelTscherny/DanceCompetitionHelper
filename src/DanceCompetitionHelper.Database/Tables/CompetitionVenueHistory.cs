...
{
    [PrimaryKey(nameof(CompetitionVenueHistoryId), nameof(Version))]
    [Index(nameof(CompetitionId), nameof(Name), nameof(Version), IsUnique = true)]
    public class CompetitionVenueHistory : TableBase, IDefaultTrim
    {
        [Required]
