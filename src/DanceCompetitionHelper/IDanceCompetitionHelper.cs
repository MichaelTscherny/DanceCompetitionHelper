...
namespace DanceCompetitionHelper
{
    public interface IDanceCompetitionHelper : IDisposable
    {
        ...
        Task<Guid?> FindCompetitionAsync(
            Guid? byAnyId,
            CancellationToken cancellationToken,
            bool useTransaction = true);
        Task<Guid?> FindCompetitionClassAsync(
            Guid? byAnyId,
            CancellationToken cancellationToken,
            bool useTransaction = true);
        Task<Guid?> GetCompetitionAsync(
            string byName,
            CancellationToken cancellationToken,
            bool useTransaction = true);
        Task<Guid?> GetCompetitionClassAsync(
            string byName,
            CancellationToken cancellationToken,
            bool useTransaction = true);
