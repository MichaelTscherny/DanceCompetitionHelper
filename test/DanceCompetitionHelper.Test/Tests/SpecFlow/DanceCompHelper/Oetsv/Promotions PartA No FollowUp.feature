Feature: DanceCompHelper - Promotion Tests - PartA Only - No FollowUp
...
Scenario: No Multiple Start - None
    ...
    And following Competition Classes in "DanceCompHelper-db"
        ...
        | Test-Comp-01    | Panel 01             | 1       | Class-01   | Allg Sta D           |                              | Sta        | Allg     | 0        | D     | 10                    | 900                   | 100            |
    ...
    And following Classes exists in Competitions of DanceCompetitionHelper "DanceCompHelper"
        ...
        | Test-Comp-01    | Allg Sta C           |                              | Class-02   | 1                 | 0                  |                        | 0                    |                          | 0                  |
        | Test-Comp-01    | Allg La D            |                              | Class-03   | 1                 | 0                  |                        | 0                    |                          | 0                  |
        | Test-Comp-01    | Allg La C            |                              | Class-04   | 1                 | 0                  |                        | 0                    |                          | 0                  |
