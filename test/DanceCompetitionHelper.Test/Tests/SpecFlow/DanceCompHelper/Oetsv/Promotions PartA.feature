...
Scenario: No Multiple Start - None
    ...
    And following Competition Classes in "DanceCompHelper-db"
        ...
        | Test-Comp-01    | 1       | Class-01   | Allg Sta D           | Sta        | Allg     | 0        | D     | 10                    | 900                   | 100            |
        | Test-Comp-01    | 1       | Class-02   | Allg Sta C           | Sta        | Allg     | 0        | C     | 10                    | 1200                  | 100            |
        | Test-Comp-01    | 1       | Class-03   | Allg La D            | La         | Allg     | 0        | D     | 10                    | 900                   | 100            |
        | Test-Comp-01    | 1       | Class-04   | Allg La C            | La         | Allg     | 0        | C     | 10                    | 1200                  | 100            |
