...
Scenario: Import 01
    ...
    And following Classes exists in Competitions of DanceCompetitionHelper "DanceCompHelper"
        ...
        | Hans-Rueff-Gedächtnispokal | Allg.Kl. Sta D       |                              | 01         | Sta        | Allg     | 0        | D     | 900                   | 10                    | 100            | 1                 | 0                  |                        |
        | Hans-Rueff-Gedächtnispokal | Allg.Kl. Sta C       |                              | 02         | Sta        | Allg     | 0        | C     | 1500                  | 10                    | 100            | 1                 | 0                  |                        |
        | Hans-Rueff-Gedächtnispokal | Allg.Kl. La B        |                              | 03         | La         | Allg     | 0        | B     | 1300                  | 10                    | 100            | 0                 | 0                  |                        |
        | Hans-Rueff-Gedächtnispokal | Allg.Kl. Sta B       |                              | 04         | Sta        | Allg     | 0        | B     | 1300                  | 10                    | 100            | 0                 | 0                  |                        |
...
Scenario: Import 02
    ...
    And following Classes exists in Competitions of DanceCompetitionHelper "DanceCompHelper"
        | CompetitionName  | CompetitionClassName | FollowUpCompetitionClassName | OrgClassId | Discipline | AgeClass | AgeGroup | Class | MinPointsForPromotion | MinStartsForPromotion | PointsForFirst | CountParticipants | ExtraPartByWinning | ExtraPartByWinningInfo |
        | Small Tournament | Allg.Kl. Sta D       |                              | 01         | Sta        | Allg     | 0        | D     | 900                   | 10                    | 150            | 2                 | 0                  |                        |
        | Small Tournament | Allg.Kl. Sta C       |                              | 02         | Sta        | Allg     | 0        | C     | 1500                  | 10                    | 150            | 2                 | 0                  |                        |
        | Small Tournament | Allg.Kl. Sta B       |                              | 03         | Sta        | Allg     | 0        | B     | 1300                  | 10                    | 150            | 2                 | 0                  |                        |
        | Small Tournament | Allg.Kl. Sta A       |                              | 04         | Sta        | Allg     | 0        | A     | 1600                  | 10                    | 150            | 2                 | 0                  |                        |
        | Small Tournament | Allg.Kl. Sta S       |                              | 05         | Sta        | Allg     | 0        | S     | 999999999             | 10                    | 150            | 2                 | 0                  |                        |
    And following Competition Venues exists in DanceCompetitionHelper "DanceCompHelper"
        | CompetitionName  | Name       | Comment                             |
